...
class TabPostre extends StatefulWidget {
  const TabPostre({super.key});

  @override
  State<TabPostre> createState() => _TabPostreState();
}

class _TabPostreState extends State<TabPostre> {
      ...
      child: Padding(
        ...
        child: StreamBuilder(
          ...
          builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
            ...
            final List<RecetaModel> _lista_filtrada = _lista_recetas.where( (receta) => receta.categoria == 'Postre' ).toList();
