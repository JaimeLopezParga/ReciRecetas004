...
class TabBebida extends StatefulWidget {
  const TabBebida({super.key});

  @override
  State<TabBebida> createState() => _TabBebidaState();
}

class _TabBebidaState extends State<TabBebida> {
      ...
      child: Padding(
        ...
        child: StreamBuilder(
          ...
          builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
            ...
            final List<RecetaModel> _lista_filtrada = _lista_recetas.where( (receta) => receta.categoria == 'Bebida' ).toList();
