...
class TabSinFiltro extends StatefulWidget {
  const TabSinFiltro({super.key});

  @override
  State<TabSinFiltro> createState() => _TabSinFiltroState();
}

class _TabSinFiltroState extends State<TabSinFiltro> {
          ...
          builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
            ...
            return SingleChildScrollView(
              child: ExpansionPanelList.radio(
                ...
                children: _lista_recetas.map<ExpansionPanelRadio> ( (RecetaModel receta) {
