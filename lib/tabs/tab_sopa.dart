...
class TabSopa extends StatefulWidget {
  const TabSopa({super.key});

  @override
  State<TabSopa> createState() => _TabSopaState();
}

class _TabSopaState extends State<TabSopa> {
      ...
      child: Padding(
        ...
        child: StreamBuilder(
          ...
          builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
            ...
            final List<RecetaModel> _lista_filtrada = _lista_recetas.where( (receta) => receta.categoria == 'Sopa' ).toList();
